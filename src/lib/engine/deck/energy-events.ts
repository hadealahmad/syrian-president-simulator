  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        descriptionAr: 'تحويل 400 ألف ليرة لكل رب أسرة ليشتري ما يحتاجه من السوق، دون المساس بوقود المصانع.',
        costUSD: 0,
        costSYP: 950_000_000_000,
        costPC: 4,
        effectTrust: 6,
        effectRRI: -8,
        effectCorruption: 4,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effectCorruption: -18,
        effectCompetence: 10,
        customEffectAr: 'مصادرة 450 مليار ل.س واستئصال شبكة فساد استيراد الفيول المغشوش (+14 ثقة)',
        governorateEffects: [
