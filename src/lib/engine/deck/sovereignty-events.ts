...
export const SOVEREIGNTY_EVENTS: EventCard[] = [
    ...
    options: [
      {
        ...
        descriptionAr: 'توثيق الخرق دولياً عبر قوات حفظ السلام والوجود الميداني لردع التمادي دون تفجير حرب.',
        costUSD: 0,
        costSYP: 500_000_000,
        costPC: 10,
        effectTrust: 8,
  ...
  },
  {
    ...
    titleAr: 'العصيان المدني وإغلاق الإدارات الحكومية والمالية في السويداء',
    category: 'SOUTHERN',
    ...
    options: [
      {
        ...
        effectCorruption: -4,
        effectCompetence: 14,
        customEffectAr: 'طفرة في عوائد موانئ الساحل بـ 4B SP وتعميق الاندماج الاقتصادي مع بغداد',
        governorateEffects: [
