    ...
    options: [
      {
        ...
        effectCorruption: -12,
        effectCompetence: 8,
        customEffectAr: 'كسر الاحتكار فوراً ومصادرة 3.50B SP واستئناف مشاريع البناء (+14 ثقة)',
        governorateEffects: [
    ...
    options: [
      {
        ...
        effectCorruption: -8,
        effectCompetence: 10,
        customEffectAr: 'حماية آلاف الوظائف النسيجية بحلب ومصادرات بـ 2.80B SP مع تذمر تجار التجزئة',
        governorateEffects: [
      ...
      },
      {
        ...
        costUSD: 0,
        costSYP: -5_500_000_000,
        costPC: -4,
        effectTrust: -6,
        effectRRI: 4,
        effectCorruption: 8,
        effectCompetence: -4,
        customEffectAr: 'جباية 5.50B SP للخزينة مع استياء صناعيي حلب من استمرار المنافسة الخارجية',
        governorateEffects: [
