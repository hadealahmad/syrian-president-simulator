...
export const SERVICES_EVENTS: EventCard[] = [
  {
    ...
    triggerCondition: (state) => state.macro.civilServiceWageSYP < 25_000 || state.macro.annualInflationPct > 20,
    options: [
      {
  ...
  },
  {
    ...
    triggerCondition: (state) => state.macro.civilServiceWageSYP < 28_000,
    options: [
      {
