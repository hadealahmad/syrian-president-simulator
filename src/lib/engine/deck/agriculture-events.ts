  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effectCorruption: 10,
        effectCompetence: -8,
        customEffectAr: 'جباية 0.80B SP غرامات مع تدمير سمعة المنتجات الزراعية وتفشي الأمراض (+16 احتقان)',
        governorateEffects: [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        effectCorruption: 8,
        effectCompetence: -2,
        customEffectAr: 'مصادرات بـ 1.20B SP مع اشتباكات مع المهربين وتذمر الفلاحين (+12 احتقان)',
        governorateEffects: [
