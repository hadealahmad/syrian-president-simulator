...
export const STAT_EXPLAINERS_AR: Record<string, string> = {
  ...
  treasurySYP:
    'خزينة الدولة بـSP: المهم ليس الرصيد وحده بل التركيبة — إنفاق تشغيلي (رواتب ودعم يُستهلك) مقابل استثماري (مشاريع وشبكة تبني إيراد الغد). السالب المفتوح مسموح (عجز ودين حكومي) دون طباعة قسرية، والمسار يُقاس بالأدوار المتبقية قبل نفاد الاحتياطي.',
  reservesUSD:
