  ...
  const STEPS = [
    ...
    },
    {
      ...
      sections: [
        ...
        {
          label: 'احتياطي النقد الأجنبي (USD) ومؤشر الأمان',
          desc: 'مخزون العملات الصعبة في مصرف سورية المركزي؛ الدرع الأساسي لاستيراد القمح والمحروقات والمستلزمات الطبية. يوضح "مؤشر الأمان" عدد الأشهر المتبقية قبل نفاد السيولة الصعبة إذا استمر العجز.',
          tag: 'الاحتياطي الاستراتيجي',
        },
        {
          label: 'الرصيد السياسي (Political Credit)',
        ...
        },
        {
          ...
          desc: 'معدل صرف الليرة مقابل الدولار والتضخم السنوي؛ مؤشران يعكسان القدرة الشرائية للمواطنين وتآكل الرواتب في الأسواق الحقيقية.',
    ...
    },
    {
      ...
      sections: [
        {
          label: 'ارتفاع الأعمدة (منسوب الإعمار)',
          desc: 'تمثل النوى السداسية محافظات الجمهورية الـ 14. يعكس ارتفاع العمود المنسوب الإنشائي ورأس المال العامل المتاح في المحافظة.',
          tag: 'البنية التحتية',
        },
        {
        ...
        {
          label: 'مؤشر الاحتقان (PRRI) وأجهزة الإنذار',
          desc: 'تتلون الأعمدة بحسب الحالة الأمنية: الأخضر (مستقرة)، الأصفر (متوترة)، الخمري (اضطرابات مع تنبيه نبضي)، والأحمر القاني (تمرد مسلح مع وميض طوارئ).',
    ...
    },
    {
      id: 'drawers',
      badge: 'الفصل 04',
      title: 'إدارة المحافظات ومجلس الوزراء',
      subtitle: 'أجنحة القيادة اليومية: التنمية الإقليمية والسياسات القطاعية المركزية',
      spotlight: 'sidebars',
      sections: [
        {
          label: 'الجناح الأيمن: إدارة المحافظات (Provincial)',
        ...
        {
          label: 'الجناح الأيسر: مجلس الوزراء (Cabinet Ministries)',
        ...
        {
          label: 'ديوان المراسيم الرئاسية (Executive Decrees)',
    ...
    },
    {
      ...
      sections: [
        {
          label: 'مسودة القرارات (Turn Directives)',
