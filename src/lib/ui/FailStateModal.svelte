...
{#if $gameStore.isGameOver && failState}
  <div
    class="pointer-events-auto fixed inset-0 z-[80] flex items-center justify-center bg-black/30 p-4 select-none scroll-area scroll-umber overflow-y-auto font-arabic"
  >
    <div
