...
{#if $gameStore.isGameOver && failState}
  <div
    class="fixed inset-0 z-50 flex items-center justify-center bg-charcoal-deep/95 backdrop-blur-lg p-4 select-none font-arabic"
  >
    <div
      class="w-full max-w-xl bg-forest-deep border border-umber-crimson shadow-2xl p-8 space-y-6 text-center rounded-none text-wheat-light"
    >
